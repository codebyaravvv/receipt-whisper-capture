...
const BackendHealthCheck = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      checkBackendHealth();
    }, status === 'connected' ? 10000 : 5000); // More frequent checks when disconnected
    ...
    <div className="flex flex-col space-y-1 text-sm text-red-600 bg-red-50 px-3 py-2 rounded-md">
      ...
      <div className="text-xs ml-6 space-y-1">
        ...
        <ol className="list-decimal ml-4 space-y-1">
          ...
          <li>Check that port 5000 is free and not blocked by firewall</li>
          <li>Try restarting the application using the start script</li>
        </ol>
        <button 
